...
pdf_file = os.getcwd() + "\\" + os.getenv("PRIORITY_FILE")
...
class MyRetrieveUserProxyAgent(RetrieveUserProxyAgent):
    ...
    async def a_get_human_input(self, prompt: str) -> str:
        global input_future
        print('AGENT!!!!!! Awaiting user input...')
        ...
        try:
            ...
            input_value = input_future.result()
            if input_value == "exit":
                print(f"exit received from user")
                # input_value = input_value+"\r"
                # print(f"exit received from user")

            print(f"User input received: {input_value}")
        except Exception as e:
            print(f"Error while awaiting user input: {e}")
            input_value = ""  # Provide a default value to avoid crashes

        input_future = None  # Reset for the next input
        print(f"@@@@@@@ Reset input_future to None for the next input @@@@@@@")
        return input_value
